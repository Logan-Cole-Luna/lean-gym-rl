...
Usage:
    python scripts/select_checkpoint.py                       # vs the best SFT run
    python scripts/select_checkpoint.py --baseline sft-step390
    python scripts/select_checkpoint.py --metric typecheck
"""
...
# Produced before the chat-template fix; see scripts/compare_results.py.
