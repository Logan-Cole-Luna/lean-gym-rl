...
was killed in.
    ...
    python scripts/read_train_metrics.py rl3b_lr6_gated_edge
    python scripts/read_train_metrics.py rl3b_lr6_gated_edge --keys actor/kl_loss,actor/entropy
    python scripts/read_train_metrics.py rl3b_lr6_gated_edge --csv out.csv
"""
import argparse
import csv
import json
