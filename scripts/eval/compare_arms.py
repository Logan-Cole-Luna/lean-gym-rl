...
Usage:
    python scripts/eval/compare_arms.py rl_gated_clean rl_placebo_clean
    python scripts/eval/compare_arms.py rl3b_gated_edge rl3b_lr6_gated_edge --metric typecheck
"""
