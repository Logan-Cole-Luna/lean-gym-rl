...
| BEq+-valid targets only | 252 | 50.4% | 13.1% | +7.8 pp | 0.00055 |

## Trajectories (BEq+ %)

- **All teacher targets**  25:7.0  50:11.9  75:15.6  100:15.2  125:13.1  150:15.2  175:13.9  200:13.5
- **BEq+-valid targets only**  25:12.3  50:11.9  75:11.9  100:11.5  125:14.3  150:12.7  175:11.9  200:13.9  225:13.1  250:12.7  252:13.1

## Read

Filtering **does not help**. At the final checkpoint of each run BEq+ is 13.5% (all targets, step 200) against 13.1% (valid only, step 252): +0.4 pp, McNemar p=1 -- not significant, and at matched steps 150/175/200 neither run leads either.
